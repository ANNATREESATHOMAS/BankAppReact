...
app.post('/register',(req,res)=>{
    dataService.register(req.body.name,req.body.email,req.body.password).then(result=>{ 
...
app.post('/deposit',(req,res)=>{
    dataService.deposit(req.body.email,req.body.password,req.body.amt).then(result=>{
        res.status(result.statusCode).json(result)
    })
})
...
app.post('/withdraw',(req,res)=>{
    dataService.withdraw(req,req.body.email,req.body.password,req.body.amt).then(result=>{
        res.status(result.statusCode).json(result)
    })
})
